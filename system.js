...
export async function promptTemplate() {
    ...
    templateBase.makeTodoList.systemPrompt = arrayAsText([
        ...
        '',
        '---',
        'Do not make check box.',
        'Do not include any code.',
        '---',
        'When creating the to-do list, consider below:',
        `- how to efficiently perform each step by utilizing appropriate tools or coding Python code.`,
        `- Refer to what methods are available in the tools for each task.`,
        '---',
    ...
    templateBase.planning.userPrompt = arrayAsText([
        ...
        '{{deepThinkingPlan}}',
        '',
        "If you are currently facing a problem, **exercise MAXIMUM flexibility**! **Absolutely and actively TRY APPROACHING IT IN A COMPLETELY DIFFERENT WAY**!",
        '',
        'The Must Achieve Mission is the most important mission. Please think deeply about it.',
        '',
