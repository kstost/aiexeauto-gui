export const i18nCaptions = {
    "ko": {
        "inspectingOutput": "결과 분석중...",
        "retrievingData": "데이터에 질의 중...",
        ...
        "inputFolderPlaceholder": "데이터 처리를 위해 연결할 폴더를 선택해주세요. (원본 데이터를 직접수정 하니 주의해주세요)",
        "newVersion": "새로운 버전",
    ...
    "en": {
        "inspectingOutput": "Inspecting output...",
        ...
        "inputFolderPlaceholder": "Please select a folder to connect for data processing. (Please be careful with the original data.)",
    ...
    "ja": {
        ...
        "inputFolderPlaceholder": "データ処理のために接続するフォルダーを選択してください。 (元のデータを直接編集するので注意してください)",
        "newVersion": "新しいバージョン",
    ...
    "vi": {
        "inspectingOutput": "Đang kiểm tra kết quả...",
        ...
        "inputFolderPlaceholder": "Vui lòng chọn thư mục để kết nối cho việc xử lý dữ liệu. (Lưu ý: Đừng sửa đổi dữ liệu gốc)",
    ...
    "zh": {
        ...
        "missionDoing": "正在执行任务",
        "inputFolderPlaceholder": "请选择要连接的文件夹以进行数据处理。 (请注意不要修改原始数据)",
        "newVersion": "新版本",
        "isAvailable": "此版本可用",
        "selectLLM": "选择要使用的LLM",
        "selectModel": "选择模型",
