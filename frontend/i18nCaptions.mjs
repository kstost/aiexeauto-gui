export const i18nCaptions = {
    "ko": {
        ...
        "inputFolderPlaceholder": "데이터 처리를 위해 연결할 폴더를 선택해주세요.",
        "newVersion": "새로운 버전",
    ...
    "en": {
        ...
        "inputFolderPlaceholder": "Please select a folder to connect for data processing.",
    ...
    "ja": {
        ...
        "inputFolderPlaceholder": "データ処理のために接続するフォルダーを選択してください。",
        "newVersion": "新しいバージョン",
    ...
    "vi": {
        ...
        "inputFolderPlaceholder": "Vui lòng chọn thư mục để kết nối cho việc xử lý dữ liệu.",
    ...
    "zh": {
        ...
        "missionDoing": "正在执行任务",
        "inputFolderPlaceholder": "请选择要连接的文件夹以进行数据处理。",
        "newVersion": "新版本",
        "isAvailable": "此版本可用",
        "selectLLM": "选择要使用的LLM",
        "selectModel": "选择模型",
